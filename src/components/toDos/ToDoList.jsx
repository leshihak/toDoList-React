    ...
    return toDos.map(toDo => {
      return (
        <div className='toDo' key={toDo.id}>
          {toDo.done ? <input type="checkbox" name="" className="checkbox" defaultChecked onClick={() => handleDoneToDo(toDo.id, false)}/> : <input type="checkbox" name="" className="checkbox" onClick={() => handleDoneToDo(toDo.id, true)}/>}
